"""
Django settings for CallWorks project.
...
SECRET_KEY = 'django-insecure-l%ac1&2)^#uyze#u$fzmjxttr1^-65)hc$nm6iamlb#d+okw#+'
...
WSGI_APPLICATION = 'CallWorks.wsgi.application'
...
AUTH_USER_MODEL = 'webapp.CallWorksUser'
